...
COPY app.py client_data_service.py matrixai.py clinic_functions.py rag_setup.py redis_history.py tenant_config_manager.py clinic_index.py service_disambiguation.py message_completeness_analyzer.py ./
COPY base/ ./base/
COPY static ./static/
