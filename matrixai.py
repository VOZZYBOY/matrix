...
- RAG (Поиск по базе знаний): Используй ТОЛЬКО для ЗАПРОСОВ ОПИСАНИЯ услуг или врачей ("Что такое X?", "Расскажи про Y", "Подробнее о Z"). Я предоставлю контекст. Синтезируй ответ на его основе. НЕ ВЫЗЫВАЙ функции для запросов описаний.
